...
type CalendarProps = ComponentProps<typeof RangeCalendar>;
type CalendarValue = NonNullable<CalendarProps["value"]>;
type CalendarDateValue = CalendarValue["start"];
...
export default function FunStats() {
  ...
  const [range, setRange] = useState<CalendarValue>(defaultRange);
